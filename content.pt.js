...
const DIMENSIONS_PT = [
 {id:"estandar",label:"Padrão e expectativas",principio:"Informar não é dar clareza.",
  actions:[
   {int:true, t:"Combinar com {nombre} o que se espera dela nos primeiros 30 dias e como ela saberá que vai bem."},
   {int:true, t:"Mostrar exemplos concretos de como é \u201cfazer bem\u201d aqui, não apenas descrever."},
   {int:false,t:"Repassar de novo com ela toda a informação da integração, para não restar nenhuma dúvida."},
   {int:false,t:"A prática do dia a dia vai esclarecendo as dúvidas e as prioridades."},
   {int:false,t:"Entregar o manual de procedimentos para que ela estude por conta própria."}],
 ...
 {id:"conexion",label:"Conexão e pertencimento",principio:"O pertencimento se projeta, não acontece sozinho.",
  actions:[
   {int:true, t:"Designar um colega de referência para as primeiras semanas dela."},
   {int:true, t:"Criar alguns momentos concretos para ela interagir com a equipe, além do \u201coi\u201d do primeiro dia."},
   {int:true, t:"Perguntar, ao longo da semana, como ela está se sentindo com a equipe, não só com as tarefas."},
   {int:true, t:"Criar um espaço com a equipe para trabalhar os Vision Boards (quadros dos sonhos) e convidar {nombre} a fazer o dela."},
   {int:false,t:"Confiar que, como a equipe é muito aberta, ela vai se integrar sozinha."},
   {int:false,t:"Deixar que ela marque o ritmo e se aproxime quando se sentir à vontade."}],
  mirror:"Um bom plano aqui projeta a integração com ações concretas: não basta receber alguém, é preciso fazê-la sentir-se parte. Se vocês criaram momentos e apoios para {nombre} se integrar, muito bem! Se deixaram por conta do tempo ou da iniciativa dela, lembrem-se: o pertencimento se projeta, não acontece sozinho."},
 {id:"conversaciones",label:"Conversas e acompanhamento",principio:"O silêncio não significa que está tudo bem.",
  actions:[
   ...
   {int:false,t:"Estar disponível caso ela precise de algo; se houver um problema, ela vai avisar."},
   {int:false,t:"Falar com ela só quando aparecer um erro para corrigir."},
   {int:false,t:"Perguntar \u201ctudo bem?\u201d de passagem e seguir em frente se ela disser que sim."}],
 ...
 {id:"integracion",label:"Integração e equidade",principio:"Equidade não é igualdade.",
  actions:[
   ...
   {int:true, t:"Dedicar mais tempo a ela se tiver mais dificuldade, explicando à equipe que o objetivo é que todos cheguem ao mesmo nível."},
   {int:true, t:"Apoiar-se em um colega experiente para acompanhar parte do aprendizado dela, sem largar você o acompanhamento."},
...
const CHALLENGES_PT = {
 crecer:{fortaleza:"Vontade de crescer",reto:"a impaciência pelos resultados",
  ...
  options:[
   {t:"Conversar sobre os erros e reforçar que respeite cada passo do processo, seja qual for o volume.",porQue:"Fica só na correção: aponta o erro, mas não reconhece o ponto forte dela nem combina como sustentar o ritmo sem perder qualidade."},
   {t:"Reconhecer a orientação a resultados dela e, sobre o que aconteceu hoje, mostrar o impacto —dois erros e uma garantia errada— e combinar juntos o que manter (o empenho) e o que mudar (garantir os passos-chave nos picos).",best:true,porQue:"Segue o EIC: parte de um exemplo concreto, nomeia o impacto real e combina o que continuar e o que mudar. Desenvolve sem apagar o ponto forte dela."},
   ...
   {t:"Pedir que, nos momentos de mais movimento, ela reduza o ritmo para minimizar erros.",porQue:"Freia justamente o ponto forte dela em vez de canalizá-lo: você pede que seja menos, não melhor."}]},
 conexion:{fortaleza:"Cria conexões genuínas",reto:"evitar as conversas difíceis",
  esc:"{nombre} gera um clima excelente e se dá muito bem com todo mundo. Você percebe uma oportunidade de melhora no desempenho dela, mas ela evita as conversas desconfortáveis para não estragar a boa relação, e vai adiando temas que precisariam ser tratados.",
  options:[
   ...
   {t:"Reconhecer o bom clima dela e ir inserindo melhorias aos poucos nos acompanhamentos.",porQue:"Sem nomear o exemplo nem o impacto, a mensagem se dilui e não se combina nada concreto."}]},
 actitud:{fortaleza:"Atitude positiva diante dos desafios",reto:"aguentar demais e se isolar",
  ...
  options:[
   {t:"Respeitar o espaço dela e estar disponível caso queira conversar.",porQue:"A disponibilidade passiva deixa o peso em quem justamente não pede ajuda."},
   {t:"Reconhecer a capacidade de aguentar dela e lembrar que a equipe a/o apoia.",porQue:"Reforça o aguentar —o ponto forte em excesso— em vez de abrir o que está acontecendo."},
   {t:"Fazer um acompanhamento próximo: partir de algo concreto que você observou, nomear o impacto (te vejo mais apagado/a, participa menos) e combinar como se cuidar e quando pedir apoio, valorizando a fibra dela.",best:true,porQue:"EIC aplicado com cuidado —observa, nomeia o impacto e combina— e rompe o \u201ctudo bem\u201d com fatos concretos."},
   {t:"Reduzir temporariamente as responsabilidades dela até que esteja melhor.",porQue:"Você decide por ela/ele sem entender o que houve; pode soar como castigo."}]},
 energia:{fortaleza:"Energia que inspira",reto:"ofuscar o resto da equipe",
  esc:"{nombre} conecta com facilidade e é uma referência natural. Nas reuniões, muitos esperam a opinião dela antes de falar e, com o tempo, alguns participam cada vez menos.",
  options:[
   {t:"Mudar a dinâmica das reuniões para que todos participem por igual.",porQue:"Resolve o sintoma na sala, mas não fala com {nombre} nem desenvolve o papel dela."},
   {t:"Pedir que ela intervenha menos para dar espaço aos outros.",porQue:"Apaga o ponto forte dela: você pede que brilhe menos em vez de usar a influência a favor da equipe."},
   {t:"Reconhecer a influência dela e pedir que incentive os outros a compartilhar.",porQue:"Boa direção, mas sem exemplo concreto nem impacto nomeado vira só uma tarefa genérica."},
   {t:"Conversar sobre um momento concreto em que o peso dela calou o resto, mostrar o impacto (colegas que já não opinam) e combinar como transformar a influência dela em desenvolver os outros, sem perder a energia.",best:true,porQue:"EIC completo e reenquadra o ponto forte como alavanca para a equipe, não como problema."}]},
 cumple:{fortaleza:"Cumpre o que promete",reto:"a rigidez diante da mudança",
  ...
  options:[
   ...
   {t:"Manter o jeito de vender dela enquanto der bons resultados.",porQue:"Evita o desenvolvimento: o ponto forte fica na zona de conforto."},
 ...
 aprende:{fortaleza:"Aprende e busca melhorar",reto:"dispersar-se e se entediar com a rotina",
  ...
  options:[
   {t:"Falar da importância de manter o mesmo comprometimento em tudo e fixar expectativas claras.",porQue:"Só corrige e põe regras; não aproveita o ponto forte dela nem combina nada que a motive."},
   ...
   {t:"Partir de uma tarefa rotineira concreta que ficou pela metade, mostrar o impacto na equipe e na loja, e combinar como canalizar a curiosidade dela sem largar o operacional, com acompanhamento.",best:true,porQue:"EIC e equilibra ponto forte e constância com um acordo concreto."},
   {t:"Rodá-la mais entre tarefas para que não se entedie.",porQue:"Remendo organizacional: não desenvolve a constância dela, só esconde o problema."}]},
 experiencias:{fortaleza:"Cria experiências memoráveis",reto:"envolver-se demais e pular o processo",
  ...
  options:[
   {t:"Explicar que, diante de qualquer exceção, ela deve consultar antes.",porQue:"Põe uma regra sem reconhecer a entrega dela nem combinar um critério."},
   {t:"Reconhecer o comprometimento dela, revisar o caso concreto, mostrar o impacto da exceção na equipe e combinar como equilibrar cliente e padrão: o que manter e o que mudar.",best:true,porQue:"EIC completo e protege o ponto forte dela dando um marco para usá-lo bem."},
   {t:"Lembrar a equipe de quais exceções a empresa permite.",porQue:"Generaliza; {nombre} não recebe a conversa de que precisa."},
   {t:"Pedir que ela priorize o processo acima do cliente.",porQue:"Apaga justamente o ponto forte dela: inverte o problema em vez de equilibrá-lo."}]},
 rol:{fortaleza:"Assume o seu papel",reto:"agir por conta própria",
  ...
  options:[
   {t:"Pedir que, a partir de agora, consulte tudo o que fuja do habitual.",porQue:"Mata a autonomia dela —o ponto forte— com um controle total."},
   {t:"Reconhecer a iniciativa dela, revisar a decisão concreta que tomou, mostrar o impacto na equipe e combinar juntos o que pode decidir sozinha e o que precisa alinhar, compartilhando depois com a equipe.",best:true,porQue:"EIC e transforma a autonomia dela em autonomia com critério, sem apagá-la."},
   ...
   {t:"Deixar que esse tipo de decisão fique só nas suas mãos.",porQue:"Centraliza e desperdiça a capacidade de resolver dela."}]},
 detalle:{fortaleza:"Cuida de cada detalhe",reto:"o perfeccionismo que trava",
  ...
  options:[
   {t:"Pedir que, em alta demanda, ela priorize a rapidez e deixe os detalhes para depois.",porQue:"Dá uma regra oposta ao ponto forte dela sem combinar um critério; oscila de um extremo ao outro."},
   {t:"Reconhecer a exigência dela, partir do dia concreto, mostrar o impacto (clientes esperando, equipe tensa) e combinar como distinguir quando o detalhe agrega e quando trava.",best:true,porQue:"EIC e dá critério para calibrar o ponto forte dela, não para abrir mão dele."},
   {t:"Lembrar a equipe de equilibrar apresentação e agilidade.",porQue:"Generaliza; {nombre} não recebe a conversa concreta."},
   {t:"Manter o jeito de trabalhar dela porque eleva o padrão.",porQue:"Evita o desenvolvimento: o perfeccionismo segue travando o atendimento."}]}
};

const GENERIC_PT = { multi:true, fortaleza:"Encaixa tão bem com a equipe",reto:"a amizade que contamina o trabalho",
  esc:"{nombre} se encaixou tão bem na equipe que a sintonia é total: todos viraram amigos e fazem planos fora do trabalho. A harmonia se rompe quando {nombre} descobre que duas colegas falam mal dela pelas costas —criticam-na por algo que aconteceu fora do trabalho— e agora não colaboram em nada. {nombre} vem te contar com todos os detalhes do que houve fora, e critica as colegas.",
  options:[
   {t:"Você a escuta e dá a sua opinião e um conselho sobre como ela deveria resolver.",porQue:"Você resolve por ela; o conflito é dela e você a torna dependente em vez de desenvolver a capacidade de administrá-lo."},
   ...
   {t:"Você não deixa que ela continue falando do que houve fora do trabalho e reconduz para fatos concretos dentro do trabalho.",valid:true,porQue:"Você põe o limite certo: o pessoal de fora não é sua jurisdição; o que você administra é o impacto no trabalho (não colaborarem)."},
   {t:"Você faz perguntas sobre como ela acha que poderia resolver com as colegas.",valid:true,porQue:"Coaching e empoderamento: você devolve a propriedade do problema a quem o tem."},
